<div class="box box-primary">
	...
	<form action="<?php echo base_url('admin/harga_bahan/update/'.$this->uri->segment(4)) ?>" method="post">
		<div class="box-body">
			<div class="col-lg-6">
				<div class="form-group">
					...
					<select class="form-control" name="ukuran">
						...
						<?php foreach ($this->ukuran_baju_model->list() as $value) : ?>
							<option value="<?php echo $value['id'] ?>" <?php echo $value['id'] == set_value('ukuran', $harga_bahan['ukuran'])?'selected':'' ?>><?php echo $value['nama'] ?></option>
						<?php endforeach; ?>
					</select>
				...
				<div class="form-group">
					<label>Harga</label>
					<input type="text" name="harga" class="form-control" placeholder="Harga" value="<?php echo set_value('harga', $harga_bahan['harga']) ?>">
