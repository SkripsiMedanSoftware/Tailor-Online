<div class="box box-primary">
	...
	<form action="<?php echo base_url('admin/ukuran_baju/add/') ?>" method="post">
		<div class="box-body">
			<div class="col-lg-6">
				<div class="form-group">
					<label>Ukuran</label>
					<input class="form-control" type="text" name="nama" placeholder="Ukuran" value="<?php echo set_value('nama') ?>">
