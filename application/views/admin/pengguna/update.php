<div class="box box-primary">
	...
	<form action="<?php echo base_url('admin/pengguna/update/'.$pengguna['id']) ?>" method="post" enctype="multipart/form-data">
		<div class="box-body">
			<div class="col-lg-6">
				<div class="form-group">
					...
					<select class="form-control" name="role">
						...
						<option class="customer" <?php echo $pengguna['role'] == 'customer'?'selected':'' ?>>Customer</option>
					</select>
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="username" placeholder="Username" value="<?php echo set_value('username', $pengguna['username']) ?>">
				...
				<div class="form-group">
					<label>Alamat</label>
					<textarea class="form-control" name="alamat" placeholder="Alamat"><?php echo set_value('alamat', $pengguna['alamat']) ?></textarea>
